"""Regression checks for the summit-data-lake-forge casebook."""
...
from casebook.harness import assert_expected, summit_data_lake_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(summit_data_lake_forge_summary(), assert_expected())
